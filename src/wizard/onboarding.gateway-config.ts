...
import type { GatewayBindMode, GatewayTailscaleMode, OpenBotConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.openbot.ai/gateway/tailscale", "https://docs.openbot.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
