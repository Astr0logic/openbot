...
describe("createOpenBotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createOpenBotCodingTools({
      config,
    ...
    const anthropicTools = createOpenBotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createOpenBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createOpenBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
