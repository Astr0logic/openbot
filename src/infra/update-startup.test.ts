...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "openbot-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveOpenBotPackageRoot } = await import("./openbot-root.js");
    ...
    vi.mocked(resolveOpenBotPackageRoot).mockResolvedValue("/opt/openbot");
