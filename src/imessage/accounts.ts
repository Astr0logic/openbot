...
export function listIMessageAccountIds(cfg: OpenBotConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: OpenBotConfig): string {
...
function mergeIMessageAccountConfig(cfg: OpenBotConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OpenBotConfig): ResolvedIMessageAccount[] {
