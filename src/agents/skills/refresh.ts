...
function resolveWatchPaths(workspaceDir: string, config?: OpenBotConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenBotConfig }) {
