...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOpenBotAgentDir() returns mainAgentDir
    process.env.OPENBOT_STATE_DIR = tmpDir;
    process.env.OPENBOT_AGENT_DIR = mainAgentDir;
