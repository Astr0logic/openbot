...
<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/openbot/openbot/main/docs/assets/openbot-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/openbot/openbot/main/docs/assets/openbot-logo-text.png" alt="OpenBot" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/openbot/openbot/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/openbot/openbot/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/openbot/openbot/releases"><img src="https://img.shields.io/github/v/release/openbot/openbot?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**OpenBot** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://openbot.ai) · [Docs](https://docs.openbot.ai) · [DeepWiki](https://deepwiki.com/openbot/openbot) · [Getting Started](https://docs.openbot.ai/start/getting-started) · [Updating](https://docs.openbot.ai/install/updating) · [Showcase](https://docs.openbot.ai/start/showcase) · [FAQ](https://docs.openbot.ai/start/faq) · [Wizard](https://docs.openbot.ai/start/wizard) · [Nix](https://github.com/openbot/nix-clawdbot) · [Docker](https://docs.openbot.ai/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`openbot onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.openbot.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.openbot.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.openbot.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.openbot.ai/concepts/model-failover)
...
# or: pnpm add -g openbot@latest

openbot onboard --install-daemon
```
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.openbot.ai/start/getting-started)

```bash
openbot onboard --install-daemon

openbot gateway --port 18789 --verbose

# Send a message
openbot message send --to +1234567890 --message "Hello from OpenBot"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
openbot agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.openbot.ai/install/updating) (and run `openbot doctor`).
...
Switch channels (git + npm): `openbot update --channel stable|beta|dev`.
Details: [Development channels](https://docs.openbot.ai/install/development-channels).
...
```bash
git clone https://github.com/openbot/openbot.git
cd openbot
...
pnpm openbot onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm openbot ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `openbot` binary.

## Security defaults (DM access)

OpenBot connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.openbot.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `openbot pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `openbot doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.openbot.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.openbot.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.openbot.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.openbot.ai/nodes/voicewake) + [Talk Mode](https://docs.openbot.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.openbot.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.openbot.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.openbot.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.openbot.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.openbot.ai/nodes).
- **[Onboarding](https://docs.openbot.ai/start/wizard) + [skills](https://docs.openbot.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=openbot/openbot&type=date&legend=top-left)](https://www.star-history.com/#openbot/openbot&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.openbot.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.openbot.ai/web), and [Canvas host](https://docs.openbot.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.openbot.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.openbot.ai/start/wizard), and [doctor](https://docs.openbot.ai/gateway/doctor).
- [Pi agent runtime](https://docs.openbot.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.openbot.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.openbot.ai/concepts/groups).
- [Media pipeline](https://docs.openbot.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.openbot.ai/nodes/audio).

### Channels

- [Channels](https://docs.openbot.ai/channels): [WhatsApp](https://docs.openbot.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.openbot.ai/channels/telegram) (grammY), [Slack](https://docs.openbot.ai/channels/slack) (Bolt), [Discord](https://docs.openbot.ai/channels/discord) (discord.js), [Google Chat](https://docs.openbot.ai/channels/googlechat) (Chat API), [Signal](https://docs.openbot.ai/channels/signal) (signal-cli), [iMessage](https://docs.openbot.ai/channels/imessage) (imsg), [BlueBubbles](https://docs.openbot.ai/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.openbot.ai/channels/msteams) (extension), [Matrix](https://docs.openbot.ai/channels/matrix) (extension), [Zalo](https://docs.openbot.ai/channels/zalo) (extension), [Zalo Personal](https://docs.openbot.ai/channels/zalouser) (extension), [WebChat](https://docs.openbot.ai/web/webchat).
- [Group routing](https://docs.openbot.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.openbot.ai/channels).

### Apps + nodes

- [macOS app](https://docs.openbot.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.openbot.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.openbot.ai/nodes/talk) overlay, [WebChat](https://docs.openbot.ai/web/webchat), debug tools, [remote gateway](https://docs.openbot.ai/gateway/remote) control.
- [iOS node](https://docs.openbot.ai/platforms/ios): [Canvas](https://docs.openbot.ai/platforms/mac/canvas), [Voice Wake](https://docs.openbot.ai/nodes/voicewake), [Talk Mode](https://docs.openbot.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.openbot.ai/platforms/android): [Canvas](https://docs.openbot.ai/platforms/mac/canvas), [Talk Mode](https://docs.openbot.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.openbot.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.openbot.ai/tools/browser): dedicated openbot Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.openbot.ai/platforms/mac/canvas): [A2UI](https://docs.openbot.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.openbot.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.openbot.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.openbot.ai/automation/cron-jobs); [webhooks](https://docs.openbot.ai/automation/webhook); [Gmail Pub/Sub](https://docs.openbot.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.openbot.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.openbot.ai/concepts/channel-routing), [retry policy](https://docs.openbot.ai/concepts/retry), and [streaming/chunking](https://docs.openbot.ai/concepts/streaming).
- [Presence](https://docs.openbot.ai/concepts/presence), [typing indicators](https://docs.openbot.ai/concepts/typing-indicators), and [usage tracking](https://docs.openbot.ai/concepts/usage-tracking).
...
- [Tailscale Serve/Funnel](https://docs.openbot.ai/gateway/tailscale) or [SSH tunnels](https://docs.openbot.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.openbot.ai/install/nix) for declarative config; [Docker](https://docs.openbot.ai/install/docker)-based installs.
- [Doctor](https://docs.openbot.ai/gateway/doctor) migrations, [logging](https://docs.openbot.ai/logging).
...
- **[Gateway WebSocket network](https://docs.openbot.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.openbot.ai/gateway)).
- **[Tailscale exposure](https://docs.openbot.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.openbot.ai/gateway/remote)).
- **[Browser control](https://docs.openbot.ai/tools/browser)** — openbot‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.openbot.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.openbot.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.openbot.ai/nodes/voicewake) + [Talk Mode](https://docs.openbot.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.openbot.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

OpenBot can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (OpenBot enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.openbot.ai/gateway/tailscale) · [Web surfaces](https://docs.openbot.ai/web)
...
Details: [Remote access](https://docs.openbot.ai/gateway/remote) · [Nodes](https://docs.openbot.ai/nodes) · [Security](https://docs.openbot.ai/gateway/security)
...
Details: [Nodes](https://docs.openbot.ai/nodes) · [macOS app](https://docs.openbot.ai/platforms/macos) · [Gateway protocol](https://docs.openbot.ai/concepts/architecture)
...
Details: [Session tools](https://docs.openbot.ai/concepts/session-tool)
...
- Controlled via `openbot nodes …`.

Runbook: [iOS connect](https://docs.openbot.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.openbot.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.openbot/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.openbot/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.openbot/openbot.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.openbot.ai/gateway/configuration)
...
Details: [Security guide](https://docs.openbot.ai/gateway/security) · [Docker + sandboxing](https://docs.openbot.ai/install/docker) · [Sandbox config](https://docs.openbot.ai/gateway/configuration)

### [WhatsApp](https://docs.openbot.ai/channels/whatsapp)

- Link the device: `pnpm openbot channels login` (stores creds in `~/.openbot/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.openbot.ai/channels/telegram)
...
### [Slack](https://docs.openbot.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.openbot.ai/channels/discord)
...
### [Signal](https://docs.openbot.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.openbot.ai/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.openbot.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.openbot.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.openbot.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.openbot.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.openbot.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.openbot.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.openbot.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.openbot.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.openbot.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.openbot.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.openbot.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.openbot.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.openbot.ai/platforms/windows), [Linux](https://docs.openbot.ai/platforms/linux), [macOS](https://docs.openbot.ai/platforms/macos), [iOS](https://docs.openbot.ai/platforms/ios), [Android](https://docs.openbot.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.openbot.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.openbot.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.openbot.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.openbot.ai/gateway/bonjour)
- [Gateway pairing](https://docs.openbot.ai/gateway/pairing)
- [Remote gateway README](https://docs.openbot.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.openbot.ai/web/control-ui)
- [Dashboard](https://docs.openbot.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.openbot.ai/gateway/health)
- [Gateway lock](https://docs.openbot.ai/gateway/gateway-lock)
- [Background process](https://docs.openbot.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.openbot.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.openbot.ai/logging)

## Deep dives

- [Agent loop](https://docs.openbot.ai/concepts/agent-loop)
- [Presence](https://docs.openbot.ai/concepts/presence)
- [TypeBox schemas](https://docs.openbot.ai/concepts/typebox)
- [RPC adapters](https://docs.openbot.ai/reference/rpc)
- [Queue](https://docs.openbot.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.openbot.ai/tools/skills-config)
- [Default AGENTS](https://docs.openbot.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.openbot.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.openbot.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.openbot.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.openbot.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.openbot.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.openbot.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.openbot.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.openbot.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.openbot.ai/platforms/mac/voicewake)
- [iOS node](https://docs.openbot.ai/platforms/ios)
- [Android node](https://docs.openbot.ai/platforms/android)
- [Windows (WSL2)](https://docs.openbot.ai/platforms/windows)
- [Linux app](https://docs.openbot.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.openbot.ai/gmail-pubsub](https://docs.openbot.ai/automation/gmail-pubsub)

## Molty

OpenBot was built for **Molty**, a space jellyfish AI assistant. 🦞
by Peter Steinberger and the community.

- [openbot.ai](https://openbot.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@openbot](https://x.com/openbot)
...
Special thanks to Adam Doppelt for jellyfish.bot.
