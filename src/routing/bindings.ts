...
export function listBindings(cfg: OpenBotConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: OpenBotConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OpenBotConfig) {
