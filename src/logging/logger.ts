...
export const DEFAULT_LOG_DIR = "/tmp/openbot";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "openbot.log"); // legacy single-file path

const LOG_PREFIX = "openbot";
...
function resolveSettings(): ResolvedSettings {
  let cfg: OpenBotConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => OpenBotConfig;
      };
