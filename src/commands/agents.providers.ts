...
function resolveDefaultAccountId(cfg: OpenBotConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpenBotConfig): boolean {
...
export function summarizeBindings(cfg: OpenBotConfig, bindings: AgentBinding[]): string[] {
