...
import type { OpenBotPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: OpenBotPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: OpenBotPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
