...
export function listSlackAccountIds(cfg: OpenBotConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: OpenBotConfig): string {
...
function mergeSlackAccountConfig(cfg: OpenBotConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OpenBotConfig): ResolvedSlackAccount[] {
