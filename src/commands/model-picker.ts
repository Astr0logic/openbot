...
function resolveConfiguredModelRaw(cfg: OpenBotConfig): string {
...
function resolveConfiguredModelKeys(cfg: OpenBotConfig): string[] {
...
export function applyPrimaryModel(cfg: OpenBotConfig, model: string): OpenBotConfig {
...
export function applyModelAllowlist(cfg: OpenBotConfig, models: string[]): OpenBotConfig {
  const defaults = cfg.agents?.defaults;
