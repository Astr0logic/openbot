...
function resolveAvatarSource(cfg: OpenBotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpenBotConfig, agentId: string): AgentAvatarResolution {
