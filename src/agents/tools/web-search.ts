...
type WebSearchConfig = NonNullable<OpenBotConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: OpenBotConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("openbot configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.openbot.ai/tools/web",
  };
}
