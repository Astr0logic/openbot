...
export function applyZaiConfig(cfg: OpenBotConfig): OpenBotConfig {
...
export function applyOpenrouterProviderConfig(cfg: OpenBotConfig): OpenBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: OpenBotConfig): OpenBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: OpenBotConfig): OpenBotConfig {
...
export function applyOpenrouterConfig(cfg: OpenBotConfig): OpenBotConfig {
...
export function applyMoonshotProviderConfig(cfg: OpenBotConfig): OpenBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: OpenBotConfig): OpenBotConfig {
...
export function applyKimiCodeProviderConfig(cfg: OpenBotConfig): OpenBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OpenBotConfig): OpenBotConfig {
...
export function applySyntheticProviderConfig(cfg: OpenBotConfig): OpenBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OpenBotConfig): OpenBotConfig {
...
export function applyXiaomiProviderConfig(cfg: OpenBotConfig): OpenBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OpenBotConfig): OpenBotConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OpenBotConfig): OpenBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OpenBotConfig): OpenBotConfig {
