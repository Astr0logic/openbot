...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.openbot.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("openbot hooks list")}`,
      `  ${formatCliCommand("openbot hooks enable <name>")}`,
      `  ${formatCliCommand("openbot hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
