...
export const A2UI_PATH = "/__openbot__/a2ui";

export const CANVAS_HOST_PATH = "/__openbot__/canvas";

export const CANVAS_WS_PATH = "/__openbot__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.openbotCanvasA2UIAction.postMessage(...)
  // - Android: window.openbotCanvasA2UIAction.postMessage(...)
  const handlerNames = ["openbotCanvasA2UIAction"];
  ...
  globalThis.OpenBot = globalThis.OpenBot ?? {};
  globalThis.OpenBot.postMessage = postToNode;
  globalThis.OpenBot.sendUserAction = sendUserAction;
  globalThis.openbotPostMessage = postToNode;
  globalThis.openbotSendUserAction = sendUserAction;
