...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: OpenBotConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: OpenBotConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: OpenBotConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: OpenBotConfig): void {
