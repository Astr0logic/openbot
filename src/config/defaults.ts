...
function resolveAnthropicDefaultAuthMode(cfg: OpenBotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OpenBotConfig): OpenBotConfig {
...
export function applyTalkApiKey(config: OpenBotConfig): OpenBotConfig {
...
export function applyModelDefaults(cfg: OpenBotConfig): OpenBotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OpenBotConfig): OpenBotConfig {
...
export function applyLoggingDefaults(cfg: OpenBotConfig): OpenBotConfig {
...
export function applyContextPruningDefaults(cfg: OpenBotConfig): OpenBotConfig {
...
export function applyCompactionDefaults(cfg: OpenBotConfig): OpenBotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
