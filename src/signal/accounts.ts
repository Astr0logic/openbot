...
export function listSignalAccountIds(cfg: OpenBotConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: OpenBotConfig): string {
...
function mergeSignalAccountConfig(cfg: OpenBotConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OpenBotConfig): ResolvedSignalAccount[] {
