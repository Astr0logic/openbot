...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.OPENBOT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: OpenBotConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: OpenBotConfig): string {
...
function mergeTelegramAccountConfig(cfg: OpenBotConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: OpenBotConfig): ResolvedTelegramAccount[] {
