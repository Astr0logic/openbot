...
const ensureOpenBotModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveOpenBotAgentDir = vi.fn().mockReturnValue("/tmp/openbot-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/openbot-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureOpenBotModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveOpenBotAgentDir,
}));
