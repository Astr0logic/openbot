...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.OPENBOT_STATE_DIR;
  const configPath = env.OPENBOT_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    OPENBOT_PROFILE: profile,
    OPENBOT_STATE_DIR: stateDir,
    OPENBOT_CONFIG_PATH: configPath,
    OPENBOT_GATEWAY_PORT: String(port),
    OPENBOT_GATEWAY_TOKEN: token,
    OPENBOT_LAUNCHD_LABEL: resolvedLaunchdLabel,
    OPENBOT_SYSTEMD_UNIT: systemdUnit,
    OPENBOT_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    OPENBOT_SERVICE_KIND: GATEWAY_SERVICE_KIND,
    OPENBOT_SERVICE_VERSION: VERSION,
  };
}
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    OPENBOT_STATE_DIR: stateDir,
    OPENBOT_CONFIG_PATH: configPath,
    OPENBOT_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    OPENBOT_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    OPENBOT_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    OPENBOT_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    OPENBOT_LOG_PREFIX: "node",
    OPENBOT_SERVICE_MARKER: NODE_SERVICE_MARKER,
    OPENBOT_SERVICE_KIND: NODE_SERVICE_KIND,
    OPENBOT_SERVICE_VERSION: VERSION,
  };
}
