...
function listConfiguredAccountIds(cfg: OpenBotConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: OpenBotConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpenBotConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: OpenBotConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: OpenBotConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpenBotConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpenBotConfig): ResolvedWhatsAppAccount[] {
