...
import { type OpenBotConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpenBotConfig): string[] {
...
export function listAgentsForGateway(cfg: OpenBotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpenBotConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: OpenBotConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: OpenBotConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: OpenBotConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: OpenBotConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: OpenBotConfig): GatewaySessionsDefaults {
