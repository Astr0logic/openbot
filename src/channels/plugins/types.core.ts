...
export type ChannelAgentToolFactory = (params: { cfg?: OpenBotConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OpenBotConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OpenBotConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OpenBotConfig }) => boolean;
  supportsCards?: (params: { cfg: OpenBotConfig }) => boolean;
