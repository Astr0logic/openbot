...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "openbot-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<OpenBotConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<OpenBotConfig["telegram"]>>,
