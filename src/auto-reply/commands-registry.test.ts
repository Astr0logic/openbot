...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@openbot", { botUsername: "openbot" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@openbot args", {
        botUsername: "openbot",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "openbot" })).toBe(
      "/help@otherbot",
    );
  });
